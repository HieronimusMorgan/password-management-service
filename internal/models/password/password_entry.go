...
type PasswordEntry struct {
	...
	Tags              []*PasswordTag `gorm:"many2many:password_entry_tags, joinForeignKey:entry_id,joinReferences:tag_id;constraint:OnUpdate:CASCADE,OnDelete:SET NULL;" json:"tags,omitempty"`
